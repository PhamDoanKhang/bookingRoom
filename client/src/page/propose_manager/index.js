import Styles from "./propose_manager.module.css";
...
import PopupProposeEye from "../../components/PopupProposeEye";
...
function ProposeManager() {
    ...
    const [showEyePropose,setShowEyePropose] = useState(false)
    const [eyeData,serEyeData] = useState("");
            ...
            render: (room)=>{
                return (
                    <div className={Styles["manager_room-btn"]}>
                        <div></div>
                        <Button type="ghost" onClick={()=>{HandelShowPropose(room)}}>Xem</Button>
                    </div>
                )
            }
        },
   ...
   const HandelShowPropose = (room)=>{
        setShowEyePropose(true)
        serEyeData(room);
   }
            ...
            <div className={Styles["manager_room-container"]}>
                <div>
                    <div className={Styles["manager_room-title"]}>
                        ...
                        {showEyePropose && <PopupProposeEye setShowEyePropose={setShowEyePropose} data={eyeData} />}
                    </div>
