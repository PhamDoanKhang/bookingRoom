                        ...
                        <div className={Styles["weekly_calender-after"]}>
                                ...
                                <table>
                                    ...
                                    <tr className={Styles["weekly_table-content"]}>
                                        <td>Phạm Đoan Khang</td>
                                        <td></td>
                                        <td className={Styles["weekly-center"]} ><div className={Styles["weekly-selected-option"]}><Checkbox className={Styles["border_color"]} /></div></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr className={Styles["weekly_table-content"]}>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td className={Styles["weekly-center"]} ><div className={Styles["weekly-selected-option"]}><Checkbox /></div></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
